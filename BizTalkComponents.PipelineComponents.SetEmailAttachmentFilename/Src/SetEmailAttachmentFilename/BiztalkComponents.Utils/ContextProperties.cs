...
namespace BizTalkComponents.Utils
{
    ...
    { 
        /// <summary>
        /// http://schemas.microsoft.com/BizTalk/2003/mime-properties#FileName
        /// </summary>
        public static readonly string FileName = SystemProperties.GetFullyQualifiedName(new MIME.FileName());
    }
}